    ...
    const handleSubmit = async (e) => {
        ...
        try {
            await addDoc(collection(db, "eleves"), {
                ...
                role: "student",
                absARemplacer: 0,
                enrolledGroupIds: [] // Pas de groupe par défaut
            });
                            ...
                            return (
                                <tr key={eleve.id} className="hover:bg-gray-50 group transition-colors">
                                    ...
                                    <td className="p-4 text-right flex items-center justify-end gap-2">
                                        ...
                                        <button onClick={() => supprimerEleve(eleve.id, `${eleve.prenom} ${eleve.nom}`)} className="bg-red-50 text-red-600 hover:bg-red-100 p-2 rounded-lg transition border border-red-200" title="Supprimer">🗑️</button>
                                    </td>
                                </tr>
                            );
                        })}
